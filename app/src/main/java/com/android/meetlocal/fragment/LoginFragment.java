...
public class LoginFragment extends BaseFragment implements View.OnClickListener,InterestListDialogFragment.Listener {
    ...
    private DeviceLoginButton mFacebookSignInButton;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mGoogleSignInButton = view.findViewById(R.id.google_login_btn);
        mFacebookSignInButton = view.findViewById(R.id.facebook_login_btn);
